  ...
  <div class="flex flex-col p-2 mx-auto md:p-4 lg:p-6 text">
    <div class="mx-auto grid grid-cols-2 lg:grid-cols-3 gap-y-1 gap-x-3">
      <div v-for="(course, index) in allowedCourses" :key="index" class="flex gap-1">
        <input
          ...
          type="checkbox"
          :value="course"
          class="accent-slate-600 dark:accent-slate-400"
        >
      ...
      <div class="flex flex-row gap-x-1 items-center">
        <input
          ...
          class="accent-slate-600 dark:accent-slate-400"
        >
        <icon-lucide-leafy-green class="text-lg text-slate-600 dark:text-slate-400" />
    ...
    <div class="mx-auto flex flex-col gap-1">
      ...
      <input
        ...
        min="100"
        max="1000"
        class="dark:accent-slate-400 w-full accent-slate-400"
      >
    </div>
    ...
    <div class="flex flex-col gap-1 mx-8">
      <label for="country" class="flex justify-between">
        ...
        <button
          ...
          class="items-center flex items-center justify-center size-8 active:bg-slate-300 dark:active:bg-slate-600 recipeCardBackground border"
