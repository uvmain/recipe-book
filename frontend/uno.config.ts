...
export default defineConfig({
  shortcuts: {
    ...
    headerButton: 'size-12 bg-white dark:bg-stone-600 overflow-hidden shadow-md hover:shadow-lg dark:shadow-stone-700 dark:hover:shadow-stone-600 transition-shadow duration-100 active:bg-stone-300 border rounded hover:cursor-pointer',
    ...
    headerSearch: 'h-11 text-xl focus:placeholder-op-0 focus:bg-stone-300 dark:focus:bg-stone-600 focus:bg-white dark:text-stone-200 text-center md:text-2xl px-2  outline-none w-1/2 md:w-1/4 dark:placeholder-stone-200',
