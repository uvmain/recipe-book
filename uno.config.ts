...
export default defineConfig({
  shortcuts: {
    'add-form-component': 'block w-full p-3 text-base font-normal text-dark bg-white bg-clip-padding border border-solid border-primary_bg-300 rounded transition ease-in-out m-0',
